...
namespace Tyuiu.RomanovMV.Sprint1.Task0.V5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Тема: Базовые навики работы в С#                                  *");
            ...
            Console.WriteLine("*********************************************************************");
            Console.WriteLine("* Написать программу, которая выислает выражение (1+2)*(1+9/3)      *");
